...
namespace Typewriter.Lexing
{
    ...
    {
        private readonly Dictionary<string, Context> _items = new Dictionary<string, Context>();
        ...
        public Context Find(string name)
        {
            ...
            {
                if (_names.ContainsKey(name) == false)
                    return null;
        ...
        private void ParseCodeModel(Assembly assembly)
        {
            ...
            foreach (var c in contexts)
            {
                ...
                _names.Add(collectionName, name);
        ...
        private void ParseExtensions(ShadowClass shadowClass)
        {
            foreach (var assembly in shadowClass.ReferencedAssemblies)
            {
                ...
                foreach (var method in methods)
                {
                    ...
                    var context = _items.Values.FirstOrDefault(c => c.Type == parameters.First().ParameterType);
        ...
        private static System.Type GetType(MemberInfo memberInfo)
        {
