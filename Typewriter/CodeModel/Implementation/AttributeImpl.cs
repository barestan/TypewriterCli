...
namespace Typewriter.CodeModel.Implementation
{
    public sealed class AttributeImpl : Attribute
    {
        ...
        public override IAttributeArgumentCollection Arguments => _arguments ?? (_arguments = AttributeArgumentImpl.FromMetadata(_metadata.Arguments, this));
        ...
        public static IAttributeCollection FromMetadata(IEnumerable<IAttributeMetadata> metadata, Item parent)
        {
